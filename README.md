...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1200&color=76B900&center=true&vCenter=true&width=650&lines=Research+Intern+%40+IIT+Jodhpur+%E2%80%94+Cognitive+Radar+Networks;Research+Intern+%40+IISc+Bangalore+%E2%80%94+FANET+%2F+SDR;RTL+Design+%2C+Hardware+Acceleration+%26+Verification;GPU-Accelerated+Signal+Processing+(CUDA)" alt="Typing SVG" />
</p>
...
I work at the intersection of **digital hardware design and signal processing** — building the compute primitives underneath ML inference and RF/audio systems, and verifying them properly rather than just simulating them once. My background is in RTL design and hardware acceleration (Verilog/SystemVerilog, FPGA, UVM), and I've been extending that into GPU-parallel computing and applied DSP research.

Currently a research intern at **IIT Jodhpur** (cognitive radar networks — MATLAB simulation of pulse-Doppler radar, LFM/OFDM waveforms) and at **IISc Bangalore's SPWiCom Lab** (FANET/SDR — UAV swarm networking, ns-3 simulation, USRP B210 hardware).
...
<p align="center">
  <img src="https://img.shields.io/badge/Verilog-CC342D?style=for-the-badge&logo=v&logoColor=white" />
  <img src="https://img.shields.io/badge/SystemVerilog-9B59B6?style=for-the-badge" />
  ...
  <img src="https://img.shields.io/badge/Xilinx_Vivado-E0115F?style=for-the-badge" />
  <img src="https://img.shields.io/badge/GNU_Radio-000000?style=for-the-badge" />
...
| [**FrameSentry**](https://github.com/joeljamesp/FrameSentry) | 3D-CNN video action recognition with anomaly detection, built for the Sony AI Internship application |
